...
//添加供应商
JsonVO<string> SupplierController::execAddSupplier(const AddSupplierDTO& dto)//返回string类型是因为code是string类型
{
...
JsonVO<string> SupplierController::execModifySupplier(const ModifySupplierDTO& dto)//返回string类型是因为code是string类型
{
	JsonVO<string> result;//返回文件保存的路径
	SupplierService service;
