...
#include "../../domain/vo/finPaymentReq/FinPaymentReqEntryVO.h"
...
public:
	//查询列表
	CREATE_API_FUN_QUERY_PAYLOAD(finPaymentReq, execQueryPayBill, FinPaymentReqQuery);
	//查询详细数据
	CREATE_API_FUN_QUERY_PAYLOAD(finPaymentReqEntry, execQueryPayDetailBill, FinPaymentReqEntryQuery);
	//添加
...
private:
	...
	//查询详细数据
	JsonVO<FinPaymentReqEntryVO> execQueryPayDetailBill(const FinPaymentReqEntryQuery& query, const PayloadDTO& payload);
	//添加
