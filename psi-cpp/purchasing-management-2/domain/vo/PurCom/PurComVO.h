...
public:
	// 绑定JSON转换方法
	friend void from_json(const json& j, PurComVO& t); // NOLINT
	friend void to_json(const json& j, PurComVO& t); // NOLINT
	BIND_TO_JSON(PurComVO, id, bill_no, bill_date, src_bill_type, \
