...
*/
#ifndef _PUR_QUOT_ENTRY_VO_
#define _PUR_QUOT_ENTRY_VO_

#include "../../GlobalInclude.h"
/**
 * 显示对象
 */
class PurQuotEntryVO
{
    //ID
...
public:
    ...
    BIND_TO_JSON(PurQuotEntryVO, id, mid, bill_no, entry_no, src_bill_type, src_bill_id, src_entry_id, src_no, material_id, unit_id, qty, tax_rate, price, discount_rate, amt, remark, custom1, custom2, version);
};
#endif