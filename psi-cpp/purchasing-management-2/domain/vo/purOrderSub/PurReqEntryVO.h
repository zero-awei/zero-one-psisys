...
*/
#ifndef _PUR_REQ_ENTRY_VO_
#define _PUR_REQ_ENTRY_VO_
...
public:
    ...
    BIND_TO_JSON(PurReqEntryVO, id, mid, bill_no, entry_no, src_bill_type, src_bill_id, src_entry_id, src_no, material_id, unit_id, qty, tax_rate, price, amt, suggest_supplier_id, ordered_qty, remark, custom1, custom2, version);
};
#endif