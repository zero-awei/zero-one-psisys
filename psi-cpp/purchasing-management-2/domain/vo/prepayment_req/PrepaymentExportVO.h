#pragma once
#ifndef _PRE_PAYMENT_EXPORT_VO_
#define _PRE_PAYMENT_EXPORT_VO_
...
public:
	BIND_TO_JSON(PrepaymentExportVO, payment_type, supplier_id, od_dept, op, amt, paid_amt,
		//付款申请单明细字段开始
		 custom1, src_on, entry_on, custom2, src_entry_id, src_bill_type,
		remark, src_bill_id,
		//明细字段结束
		is_effective, attachment, subject, bill_stage, src_no, is_auto, at_remark, bpmi_instance_id,
		is_voided, bill_no, is_rubric,  create_time, effective_time, approver, update_by, sys_org_code,
