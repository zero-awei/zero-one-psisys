...
*/
#include "stdafx.h"
#include "QueryBillListController.h"
//#include "../../service/QueryBillList/QueryBillListService.h"

JsonVO<PageVO<QueryBillListVO>> QueryBillListController::execQueryQueryBillList(const QueryBillListQuery& query, const PayloadDTO& payload)
{
	//定义一个Service
