...
#include "stdafx.h"
#include "../psi-stkmanage/api/Pyrk/PyrkController.h"


JsonVO<QueryPyrkBillDetailVO> PyrkController::execQueryPyrkBillDetail(const QueryPyrkBillDetailQuery& query)
{
