...
bool getStartArg(int argc, char* argv[]) {
	...
	std::string dbPassword = "zhongxiaohui123";
	std::string dbName = "qq";
...
int main(int argc, char* argv[]) {
	...
	vector<std::string> header{
		CharsetConvertHepler::ansiToUtf8("1"),
		CharsetConvertHepler::ansiToUtf8("2"),
		CharsetConvertHepler::ansiToUtf8("3"),
		CharsetConvertHepler::ansiToUtf8("4"),
		CharsetConvertHepler::ansiToUtf8("5"),
	};
