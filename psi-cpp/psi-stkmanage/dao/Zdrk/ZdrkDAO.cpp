...
int ZdrkDAO::insert(const StkIoEntryDO& iObj)
{
...
int ZdrkDAO::update(const StkIoDO& iObj)
{
    stringstream sql;
...
int ZdrkDAO::updateState(const StkIoDO& iObj)
{
    stringstream sql;
    // 解析条件
