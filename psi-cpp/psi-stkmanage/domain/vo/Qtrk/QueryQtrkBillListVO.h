...
*/
#ifndef _QUERY_QTRK_BILL_LIST_VO_
#define _QUERY_QTRK_BILL_LIST_VO_
...
public:
	...
	// 绑定JSON转换方法
	BIND_TO_JSON(QueryQtrkBillListVO, remark, billNo, approvalResultType, updateBy, isEffective, isVoided, billType, approver, billDate, srcBillType, approvalRemark, srcNo, updateTime, isAuto,
...
#endif // !_QUERY_QTRK_BILL_LIST_VO_
