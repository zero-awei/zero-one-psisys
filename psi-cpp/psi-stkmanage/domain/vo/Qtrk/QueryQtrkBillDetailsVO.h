...
*/
#ifndef _QUERY_QTRK_BILL_DETAILS_VO_
#define _QUERY_QTRK_BILL_DETAILS_VO_

#include "../../GlobalInclude.h"
#include "QtrkBillEntryVO.h"
...
class QueryQtrkBillDetailsVO
{
	...
	CC_SYNTHESIZE(list<QtrkBillEntryVO>, entry, Entry);

public:
	QueryQtrkBillDetailsVO() {
		remark = "";
		billNo = "Qtrk-230101-001";
		...
		entry.push_back(QtrkBillEntryVO());
	}
	// 绑定JSON转换方法
	BIND_TO_JSON(QueryQtrkBillDetailsVO, remark, billNo, approvalResultType, updateBy, isEffective, isVoided, billType, approver, billDate, srcBillType, approvalRemark, srcNo, updateTime, isAuto,
...
#endif // !_QUERY_Qtrk_BILL_DETAILS_VO_
