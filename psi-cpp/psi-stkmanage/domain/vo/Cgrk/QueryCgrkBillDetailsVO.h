...
class QueryCgrkBillDetailsVO
{
	...
	CC_SYNTHESIZE(string, invoiceTypeDictText, InvoiceTypeDictTex);
...
public:
	...
	BIND_TO_JSON(QueryCgrkBillDetailsVO, remark, billNo, approvalResultType, updateBy, isEffective, isVoided, billType, approver, billDate, srcBillType, approvalRemark, srcNo, updateTime, isAuto,
		...
		invoiceType, opDept, operator1, handler, cost, settleAmt, settledAmt, invoicedAmt, isReturned, stockIoTypeDictText, hasRpDictText, hasSwellDictText, invoiceTypeDictText, opDeptDictText, operatorDictText,
