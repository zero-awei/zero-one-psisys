#pragma once
#ifndef _QUERY_ZDRK_BILL_DETAILS_VO_
#define _QUERY_ZDRK_BILL_DETAILS_VO_

#include "../../GlobalInclude.h"
#include "ZdrkBillEntryVO.h"
/**
 * 查询单据详细信息显示对象
 */
class QueryZdrkBillDetailsVO
{
	...
	CC_SYNTHESIZE(list<ZdrkBillEntryVO>, entry, Entry);
	...
	public:
		QueryZdrkBillDetailsVO() {
			...
			entry.push_back(ZdrkBillEntryVO());
		}
		// 绑定JSON转换方法
		BIND_TO_JSON(QueryZdrkBillDetailsVO, remark, billNo, approvalResultType, updateBy, isEffective, isVoided, billType, approver, billDate, srcBillType, approvalRemark, srcNo, updateTime, isAuto,
...
#endif // ! _QUERY_ZDRK_BILL_DETAILS_VO_
