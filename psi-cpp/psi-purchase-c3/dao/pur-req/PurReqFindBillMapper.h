...
*/
#ifndef _PUR_REQ_FIND_BILL_MAPPER_
#define _PUR_REQ_FIND_BILL_MAPPER_

#include "Mapper.h"
#include "../../domain/do/pur-req/PurReqDO.h"

class PurReqFindBillMapper : public Mapper<PurReqDO>
{
public:
	PurReqDO mapper(ResultSet* resultSet) const override
	{
		...
		data.setEffective_time(resultSet->getInt(25));
		...
		//data.setDetail(resultSet->getList<PurReqEntryDO>());
		return data;
	}
};
