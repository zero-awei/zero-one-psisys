...
export function queryPurOrderEntryByMainId(data, success, fail) {
  Request.requestForm(Request.GET,currBaseUrl + 'purOrder/queryEntryByMainId',data)
    .then((data) => {
      console.log('后端返回data----', data)
      // data是后端的响应示例
      // 可以console.log(data) 在浏览器控制台查看数据
...
export function queryPurReqEntryByMainId(data, success, fail) {
  Request.requestForm(Request.GET,currBaseUrl + 'purReq/queryEntryByMainId',data)
    .then((data) => {
      console.log('后端返回data----', data)
      // data是后端的响应示例
      // 可以console.log(data) 在浏览器控制台查看数据
