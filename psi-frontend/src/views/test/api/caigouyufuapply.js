import { queryAll, close, deleteById, edit, queryAllByBillno, queryOneHav, unclose, voidById } from '@/views/yingfuyufukuan/yufuguanli/api/caigouyufuapply.js'
...
export  function handlequeryAllByBillno(){
  ...
  //查看单据详情信息
export  function handleQueryOneHav(){
    let params = {}
