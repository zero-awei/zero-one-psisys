...
public class FinPayable implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        FinPayable other = (FinPayable) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getPayableType() == null ? other.getPayableType() == null : this.getPayableType().equals(other.getPayableType()))
            && (this.getSupplierId() == null ? other.getSupplierId() == null : this.getSupplierId().equals(other.getSupplierId()))
            && (this.getOpDept() == null ? other.getOpDept() == null : this.getOpDept().equals(other.getOpDept()))
            && (this.getOperator() == null ? other.getOperator() == null : this.getOperator().equals(other.getOperator()))
            && (this.getAmt() == null ? other.getAmt() == null : this.getAmt().equals(other.getAmt()))
            && (this.getCheckedAmt() == null ? other.getCheckedAmt() == null : this.getCheckedAmt().equals(other.getCheckedAmt()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPayableType() == null) ? 0 : getPayableType().hashCode());
        result = prime * result + ((getSupplierId() == null) ? 0 : getSupplierId().hashCode());
        result = prime * result + ((getOpDept() == null) ? 0 : getOpDept().hashCode());
        result = prime * result + ((getOperator() == null) ? 0 : getOperator().hashCode());
        result = prime * result + ((getAmt() == null) ? 0 : getAmt().hashCode());
        result = prime * result + ((getCheckedAmt() == null) ? 0 : getCheckedAmt().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", payableType=").append(payableType);
        sb.append(", supplierId=").append(supplierId);
        sb.append(", opDept=").append(opDept);
        sb.append(", operator=").append(operator);
        sb.append(", amt=").append(amt);
        sb.append(", checkedAmt=").append(checkedAmt);
